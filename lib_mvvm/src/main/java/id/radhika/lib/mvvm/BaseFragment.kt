 ...
 * on 21/Mar/2020
 **/
abstract class BaseFragment<B : ViewBinding, VM : BaseVM<D>, D : BaseDao>(
    ...
    val vm: VM by lazy { ViewModelProvider(viewModelStore, defaultViewModelProviderFactory).get(getViewModel()) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        launch {
            vm.registerObserverToRender(this@BaseFragment, vm.getLiveDatas())
            vm.onCreate()
        }
    }
